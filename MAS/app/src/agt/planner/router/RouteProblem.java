...
import agt.planner.nav.NavGraph;
import agt.planner.nav.NavProblem;
import agt.planner.nav.NavState;
...
public class RouteProblem {
    ...
    // MAS2 : Goal-Test Addition
    public boolean goalTest(RouteState state) {
        
        return !hasDestination(state, state.color);
